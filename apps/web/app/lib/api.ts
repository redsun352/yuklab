...
export async function getOrderTracking(accessToken: string, orderId: string) { return request<{ location: DriverLocation }>(`/v1/tracking/orders/${orderId}/location`, auth(accessToken)); }
